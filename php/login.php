...
<head>
    ...
    <title>Connexion - Otaku'Biblio</title>
...
<body>
            ...
            <div class="collapse navbar-collapse justify-content-end" id="navbarNav">
                <ul class="navbar-nav">
                    ...
                    <div class="reg-log">
                        ...
                        <li class="login nav-item" id="activelog">
    ...
    <main class="login-page text-center">
        <div class="connexion-form-sec">
            <form action="process_login.php" id="form-login" class="text-start my-5" method="post">
                ...
                <br /><p id="password-error"><?= $_SESSION['connexion-check']; ?></p>
                <button class="btn" id="login-button" type="submit">
                    Connexion
                </button>
            </form>
        </div>
