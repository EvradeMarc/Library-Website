<?php
 session_start();
 $titre = $_SESSION['titrelivrechoisi'];
 $contenu = $_SESSION['contenulivrechoisi'];
?>
<!DOCTYPE html>
<html lang="fr">
...
<body>
    ...
    <main class="read-page">
        <h1 class="Nice-read-message">Bonne Lecture!</h1>
        <div class="read-part">
            <?php if ($titre == null): ?>
                <h2>
                    Aucun livre n'est en cours de lecture
                </h2>
            <?php else : ?>
                <h2>
                    <?= $titre; ?>
                </h2>
                <p class="content-book">
                    <?= $contenu ?>
                </p>
            <?php endif; ?>
        </div>
